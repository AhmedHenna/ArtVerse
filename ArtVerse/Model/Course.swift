...
var courses = [
    ...
    Course(title: "Procreate for Beginners", subtitle: "5 Sections - 4 Hours", text: "If you want to be a pro digital artist, you may want to learn photoshop. In this hand holdy real time tutorial, I will teach you the most essential things you will need to get started with Photoshop.", image: "Illustration 1", logo: "Photoshop", height: 250),
]
