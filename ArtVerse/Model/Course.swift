...
var courses = [
    Course(title: "Blender Beginner Tutorial", subtitle: "17 Sections - 7 Hours", description: "Blender tutorial series showing you how to use the most common features, like modelling, lighting, materials, geometry nodes and rendering - whilst making a donut.", image: "Illustration 5", logo: "Blender", height: 250),
